...
<body onload="character()">
    <div class="jumbotron">
        <div class="container">
            <nav>
                <div>
                    <a class="navbar-brand" href="./headquarters.php">Avengers Assemble at:</a>
                </div>
            </nav>
            ...
            <form id="connectionForm">
                <div class="form-group">
                    <input required type="text" name="name" id="name" class="form-control character-search-box" placeholder="(Ex. Hulk, Iron Man, Captain America, etc...)">
                </div>
